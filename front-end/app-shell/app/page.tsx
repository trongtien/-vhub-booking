        ...
        <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-blue-50 to-indigo-100">
            <div className="text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                    ...
                    <Link href="/shell-admin" className="group">
                        <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow border-2 border-transparent hover:border-gray-700">
                            <div className="text-4xl mb-4">⚙️</div>
                            <h2 className="text-2xl font-semibold mb-2 text-gray-800 group-hover:text-gray-700">
                                Admin Portal
                            </h2>
                            <p className="text-gray-600">
                                User management, settings, and administrative dashboard
                            </p>
                        </div>
                    </Link>
                </div>
